...
public abstract class Distance {
    /**
     * @param a The first polygon to check the distance for
     * @param b The second polygon to check the distance for
    ...
    /**
     * @param polygon The polygon to check the distance for
     * @param multiPolyline The multi polyline to check the distance for
    ...
    /**
     * @param polygon The polygon to check the distance for
     * @param polyline The polyline to check the distance for
    ...
    /**
     * @param polygon The polygon to check the distance for
     * @param lineSegment The line segment to check the distance for
    ...
    /**
     * @param polygon The polygon to check the distance for
     * @param point The point to check the distance for
    ...
    /**
     * @param a The first multi polyline to check the distance for
     * @param b The second multi polyline to check the distance for
    ...
    /**
     * @param a The first line segment to check the distance for
     * @param b The second line segment to check the distance for
     * @return The minimum distance between two line segments
     */
    public abstract double distance(LineSegment a, LineSegment b);

    /**
     * @param p1 The first point to check the distance for
     * @param p2 The second point to check the distance for
    ...
    public static class DistanceResult {
        public static final double INVALID_DISTANCE = Double.NaN;
        protected final double distance;
        public final Point start;
        public final Point end;
        private String message;
        private String error;
        public static final DistanceResult NO_RESULT = new DistanceResult(INVALID_DISTANCE, null, null);
        public static final DistanceResult OVERLAP_RESULT = new DistanceResult(0, null, null);
